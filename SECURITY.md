...
Replace all {{PLACEHOLDER}} values with your information:
  v-graphql     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  v-graphql             - Repository name
  ...
  https://github.com/hyperpolymath          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/v-graphql/security/advisories/new)
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/v-graphql/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/v-graphql/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/v-graphql/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/v-graphql/discussions) |
...
*Thank you for helping keep v-graphql and its users safe.* 🛡️
